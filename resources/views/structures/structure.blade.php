    ...
    <div class="col-sm-12 col-md-6">
        <div class="app-card app-card-settings shadow-sm p-4">
            ...
            <div class="app-card-body">
                <form class="settings-form" method="POST" action="{{ route('structure') }}">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="setting-input-2" placeholder="Entrez le sigle" name="sigle" >
                        @error('sigle')
                        <div class=" alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="setting-input-3" name="adresse" placeholder="Entrez l'adresse">
                        @error('adresse')
                        <div class=" alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
