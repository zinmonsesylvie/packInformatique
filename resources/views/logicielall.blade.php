                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <table class="table table-bordered table-striped table-highlight">
                      <a href="{{ route('logiciel')}}" class="btn btn-success mb-3">Nouvel logiciel<i class="bi bi-plus"></i></a>
                                <thead>
                                    <tr>
                                        <th>Numéro</th>
                                        <th>Libelle</th>
                                ...
                                <tbody>
                                    @foreach($logiciels as $logiciel)
                                        <tr>
                                            ...
                                            <td>
                                              <a href="" class="btn btn-sm btn-outline-danger" onclick="return confirm('Etes-vous sûr de vouloir supprimer cette structure?')">delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
