    ...
    <div class="col-sm-12 col-md-6">
        <div class="app-card app-card-settings shadow-sm p-4">
            ...
            <div class="app-card-body">
                <form class="settings-form" method="POST" action="{{ route('logiciel') }}">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="setting-input-2" placeholder="Entrez la licence" name="licence" >
                        @error('licence')
                        <div class=" alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="setting-input-3" name="version" placeholder="Entrez la version">
                        @error('version')
                        <div class=" alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="setting-input-4" name="editeur" placeholder="Entrez l'editeur">
                        @error('editeur')
                        <div class=" alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="setting-input-5" name="date_achat_licence" placeholder="Entrez la date d'achat de la licence">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="setting-input-6" name="date_expiration" placeholder="Entrez la date d'expiration de la licence">
