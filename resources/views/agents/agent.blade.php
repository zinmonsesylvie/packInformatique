    ...
    <div class="col-sm-12 col-md-6">
        <div class="app-card app-card-settings shadow-sm p-4">
            ...
            <div class="app-card-body">
                <form class="settings-form" method="POST" action="{{ route('agent') }}">
                    @csrf
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="setting-input-4" name="fonction" placeholder="Entrez la fonction">
                        @error('fonction')
                        <div class=" alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
